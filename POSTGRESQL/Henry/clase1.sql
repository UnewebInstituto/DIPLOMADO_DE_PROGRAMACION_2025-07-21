CREATE DATABASE bd_henry_20250825;
...
--ver tabalas en una base de datos

\d
--ver solamente una tabla
\dt  
--ver solamente vistas
\dv
--ver solamente secuencias
\ds
...
insert into estatus(
    ...
    ('En reparacion', 'El espacio está cerrado temporalmente para reparaciones o mejoras.'),
