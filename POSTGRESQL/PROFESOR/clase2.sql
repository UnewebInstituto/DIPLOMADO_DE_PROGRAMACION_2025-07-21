...
-- Nombre del esquema es 'transporte'
-- Aplica en PostgreSQL
-- Creación del esquema transporte
...
-- Tablas de modelos de autobuses
...
-- Creación de registros para la tabla de modelos de autobuses
...
-- Definición de la tabla de colores para los autobuses
...
-- Creación de registros para la tabla de colores de 
-- autobuses
...
-- Creación de la tabla de autobuses
...
-- Creación de la tabla de paradas
...
-- Creación de registros para la tabla de paradas
...
-- Creación de registros para la tabla de rutas	
...
-- Creación de la tabla rutas_autobuses
...
-- Creación de registros para la tabla conductores
...
-- Consulta anterior estableciendo alias
...
-- Creación de vista con la consulta anterior
