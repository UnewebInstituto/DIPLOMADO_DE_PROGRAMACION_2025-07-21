...
COPY transporte.autobuses (id, color_id, marca_id, modelo_id) FROM stdin;
1	1	1	1
2	4	1	2
3	1	2	3
4	4	2	4
...
COPY transporte.rutas (id, nombre, descripcion, parada_id) FROM stdin;
1	Ruta 1	Ruta que conecta la Parada Central con la Parada Norte	1
2	Ruta 2	Ruta que conecta la Parada Central con la Parada Sur	2
3	Ruta 3	Ruta que conecta la Parada Central con la Parada Este	3
4	Ruta 4	Ruta que conecta la Parada Central con la Parada Oeste	4
5	Ruta 5	Ruta circular que conecta todas las paradas principales	5
\.
